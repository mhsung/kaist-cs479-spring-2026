...
- [3D Segmentation Competition](./3d-segmentation-competition): 20%
...
| 6  | Apr 6 | **Neural Radiance Fields (NeRF)**<br>[**Slides**]({{links.lec09}}){:target="_blank"}<br>[**Recording**]({{links.rec09}}){:target="_blank"} | Apr 8 | ==Assignment 2 Session:==<br>[**NeRF**]({{links.asgmt2}}){:target="_blank"} | 
...
| 13 | May 26 | No Class (Substitute Holiday for<br>Buddha's Birthday) | May 27 | ==**Guest Lecture 3**<br>[Seungchan Kim](./guest-lecture-seungchan-kim)<br>Ph.D. Student at CMU==<br>[**Recording**]({{links.rec_guest_3}}){:target="_blank"} | 
| 14 | Jun 1 | **3D Generation**<br>[**Slides**]({{links.lec15}}){:target="_blank"}<br>[**Recording**]({{links.rec15}}){:target="_blank"} | Jun 3 | No Class (Local Elections)  | 
